import{g,e as d,K as x,r as E,A as C,I as z}from"./navigation-biFXB6Du.js";/* empty css                  */const c={kiln:"全部",visibleCount:z},v=document.getElementById("artifact-grid"),A=document.getElementById("artifact-count"),L=document.getElementById("kiln-tabs"),p=document.getElementById("load-more-wrap"),w=document.getElementById("load-more-btn"),l=document.getElementById("daily-pick"),u={answered:"qicraft_answered_questions",score:"qicraft_quiz_score",streak:"qicraft_quiz_streak"};function k(){try{return JSON.parse(localStorage.getItem(u.answered))||[]}catch{return[]}}function y(t){const e=k();e.includes(t)||(e.push(t),localStorage.setItem(u.answered,JSON.stringify(e)))}function T(){return parseInt(localStorage.getItem(u.score)||"0",10)}function Q(t){localStorage.setItem(u.score,String(T()+t))}function _(){return parseInt(localStorage.getItem(u.streak)||"0",10)}function S(t){localStorage.setItem(u.streak,String(t))}function B(){return C.filter(t=>c.kiln==="全部"||t.kiln===c.kiln)}function M(t,e=!1){const i=t.emotionalHook||"";return`
