import{b as d,c as m,e as r,r as l,A as p,f as u,h,K as f}from"./navigation-biFXB6Du.js";/* empty css                  */const a={backBtn:document.getElementById("back-detail"),linkTreasure:document.getElementById("link-treasure"),kilnTitle:document.getElementById("kiln-title"),kilnHero:document.getElementById("kiln-hero"),kilnHeroImg:document.getElementById("kiln-hero-img"),kilnName:document.getElementById("kiln-name"),kilnLocation:document.getElementById("kiln-location"),kilnHeritage:document.getElementById("kiln-heritage"),repWorks:document.getElementById("rep-works"),chapters:document.getElementById("chapters"),related:document.getElementById("related-grid"),switcher:document.getElementById("kiln-switcher")};let s="汝瓷";const k=["壹","贰","叁","肆","伍","陆","柒","捌","玖","拾"];function v(){const t=f.filter(e=>e!=="全部");a.switcher.innerHTML=t.map(e=>{const i=e===s;return`<button class="kiln-switcher-chip${i?" is-active":""}" data-kiln="${e}" aria-pressed="${i}">${e}</button>`}).join("")}function g(t){return!t||t.length===0?"":`<div class="flex items-center gap-1 mt-3 pl-1" style="color: var(--qicraft-subtle);">${t.map((i,n)=>`
